...
function updateQibla() {
  ...
  compassHeading += ((targetCompassHeading - compassHeading + 540) % 360 - 180) * 0.25;
  ...
  qiblaRotor.rotation.z += (targetOuterRot - qiblaRotor.rotation.z) * 0.2;
  ...
  qiblaInnerRotor.rotation.z += (targetInnerRot - qiblaInnerRotor.rotation.z) * 0.2;
}
